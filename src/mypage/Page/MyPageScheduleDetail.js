...
import ScheduleGroupDetailView from '../../Schedule/views/ScheduleGroupDetailView';
...
export default function MyPageScheduleDetial(props) {
    ...
    <ThemeProvider theme={mdTheme}>
      <Box sx={{ display: 'flex' }}>
        ...
        >
          ...
          <ScheduleGroupDetailView g_id ={props.match.params.g_id}
