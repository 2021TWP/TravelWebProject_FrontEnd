...
class BoardReviewListContainer extends Component {

  boardStore = BoardStore;
  
  componentDidMount() {
    this.boardStore.selectReview();
}

render() {
  const { boards, selectBoard, goCreateBoard, goBoardList, goHome, seperateBoard, goFree, goReview, goImpromptu } = this.boardStore;
...
export default observer(BoardReviewListContainer);